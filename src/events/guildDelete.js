...
module.exports = {
  ...
  async execute(client, guild) {
    ...
    const stores = [client.store, client.levels, client.activity, client.trust, client.altdetect, client.polls, client.social, client.autoroles, client.reactionroles, client.applications];
